...
rm -rf /var/www/html
mkdir /var/www/html
curl -L -o /var/www/html/index.html "https://raw.githubusercontent.com/mt-nix/nix-devops-workshop/main/terraform/files/index.html"
curl -L -o /var/www/html/surprise.gif "https://media.tenor.com/yk8nhx3fZGYAAAAj/sebas-bleizeffer.gif"
